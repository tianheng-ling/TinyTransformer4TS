set_property -dict {PACKAGE_PIN H11 IOSTANDARD LVCMOS33} [get_ports clk_100m]
create_clock -period 10.000 -name clk_100 -waveform {0.000 5.000} -add [get_ports clk_100m]
# set_property -dict { PACKAGE_PIN G11   IOSTANDARD LVCMOS33 } [get_ports { sys_clk }]; # 32MHz
# create_clock -add -name clk_100 -period 31.25 -waveform {0 15.625} [get_ports { sys_clk }];
