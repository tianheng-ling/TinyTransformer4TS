...
# declare -a data_flag_options=("PeMSData") 
declare -a data_flag_options=("AirUData") 
declare -a window_size_options=(12)

# quantization settings
declare -a quant_bit_options=(4) # 6 4)
...
lr=0.001
exp_mode="test"
# given_timestamp="2025-02-21_22-05-45" # PeMSData
given_timestamp="2025-03-04_23-49-28" # AirUData    
